import { Home, Settings, BarChart3, Shield, LogOut, ChevronLeft, ChevronRight, Truck, AlertTriangle, FileDown, MapPin, MapPinned, PackageCheck, Radio, ClipboardList, Users, GitCompare } from "lucide-react";
